...
export const initialTasks: Task[] = [
  { id: 't1', title: 'Fix Login Bug', status: 'doing', context: 'c1', tags: ['Bug'], color: '#fff0f0', createdAt: new Date().toISOString() },
  { id: 't2', title: 'Write Documentation', status: 'todo', context: 'c2', tags: ['Docs'], color: '#ffffff', createdAt: new Date().toISOString() },
  { id: 't3', title: 'Weekly Review', status: 'done', context: 'c3', tags: ['Admin'], color: '#f0f8ff', createdAt: new Date().toISOString() },
  { id: 't4', title: 'Buy Groceries', status: 'todo', context: 'c3', tags: ['Personal'], color: '#fffff0', createdAt: new Date().toISOString() },
  { id: 't5', title: 'Design System Update', status: 'todo', context: 'c2', tags: ['Design'], color: '#e6e6fa', createdAt: new Date().toISOString() }
];
